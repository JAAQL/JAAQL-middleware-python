...
QUERY__system_create_role = "SELECT setup_system_role(:name)"
QUERY__user_check_ip = "SELECT encrypted_address as ip_address FROM jaaql__user_ip WHERE the_user = :user_id AND encrypted_address = :ip_address"
QUERY__setup_application = "INSERT INTO jaaql__application (name, description) VALUES (coalesce(:name, 'default'), coalesce(:description, 'The default application'))"
QUERY__force_mfa = "UPDATE jaaql__system_singleton SET force_mfa = true"
QUERY__fetch_tenant_salt = "SELECT salt FROM jaaql__tenant WHERE name = :name"
QUERY__initialise_singleton = "UPDATE jaaql__system_singleton SET allow_system_password_reset = :allow_system_password_reset, system_public_key = :system_public_key, encrypted_system_private_key = :system_private_key, encrypted_system_symmetric_key = :system_symmetric_key"
QUERY__fetch_singleton = "SELECT * FROM jaaql__system_singleton"
QUERY__user_public_key_ins = "INSERT INTO jaaql__user_public_key (the_user, public_key) VALUES (:the_user, :password_hash)"
QUERY__system_create = "SELECT create_system(:name, :superuser_password)"
...
QUERY__grant_role = "SELECT jaaql__apply_role(:username, :role)"
QUERY__grant_default_roles = "SELECT jaaql__apply_default_roles(:user_id, :username, :the_application)"
...
QUERY__user_ins = "INSERT INTO jaaql__user (email, mobile, alias, is_public, tenant, application, public_credentials) VALUES (:email, :mobile, :alias, :is_public, :tenant, :application, :public_credentials) ON CONFLICT DO UPDATE SET id = id RETURNING id, email"
...
QUERY__user_id_from_username = "SELECT id FROM jaaql__user WHERE encrypted_email = :username AND deleted is null"
...
QUERY__user_ip_ins = "INSERT INTO jaaql__user_ip (the_user, encrypted_address) VALUES (:user_id, :ip_address) ON CONFLICT ON CONSTRAINT jaaql__user_ip_unq DO UPDATE SET most_recent_use = current_timestamp RETURNING most_recent_use <> first_use as existed, id"
QUERY__user_password_ins = "INSERT INTO jaaql__user_public_key (the_user, enc_public_key) VALUES (:the_user, :public_key)"
...
QUERY__user_create_role = "SELECT jaaql__setup_role(:username)"
